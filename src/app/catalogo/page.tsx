...
import type { Genero, Perfume } from '@/lib/types';
    ...
    <div className="catalogo-page">
      <style>{`
        ...
        @media (prefers-color-scheme: dark) {
          .catalogo-page:not([data-theme="light"]) {
            --bg: #16151a;
            --surface: #1e1c24;
            --surface-2: #26232c;
            --ink: #ece7dc;
        ...
        .catalogo-page .brand-group { border: 1px solid var(--line); border-radius: 12px; padding: 14px 14px 4px; margin: 0 0 16px; background: var(--surface); }
      ...
      <div className="wrap">
        ...
        <main>
          {loading ? (
            <p className="empty-state">Carregando catálogo…</p>
          ) : !anyVisible ? (
